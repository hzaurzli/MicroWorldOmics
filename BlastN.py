...
class BlastN_Form(QWidget):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "BlastN"))
        self.label.setText(_translate("Form", "BlastN"))
        ...
        ## action
        self.pushButton.clicked.connect(self.blastn)
    ...
    def blastn(self):
        ...
        out = self.textBrowser_.toPlainText()
