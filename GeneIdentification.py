...
class GeneIdentification_Form(QWidget):
    ...
    def setupUi(self, Clustal):
        ...
        self.textBrowser.setGeometry(QtCore.QRect(50, 390, 241, 51))
        ...
        self.label_4.setGeometry(QtCore.QRect(120, 360, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(19)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(370, 350, 311, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(15)
        ...
        self.label_6.setGeometry(QtCore.QRect(370, 320, 311, 20))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(370, 120, 311, 191))
        ...
        self.label_7.setGeometry(QtCore.QRect(50, 260, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(15)
        ...
        self.radioButton_2.setGeometry(QtCore.QRect(30, 330, 131, 21))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(13)
        ...
        self.label_8.setGeometry(QtCore.QRect(370, 50, 141, 20))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.label_9.setGeometry(QtCore.QRect(540, 50, 131, 21))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setItalic(True)
        ...
        self.label_10.setGeometry(QtCore.QRect(170, 260, 181, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setItalic(True)
        ...
        self.textEdit.setGeometry(QtCore.QRect(170, 300, 151, 31))
        ...
        self.textEdit_2.setGeometry(QtCore.QRect(370, 80, 141, 31))
        ...
        self.textEdit_3.setGeometry(QtCore.QRect(540, 80, 141, 31))
    ...
    def retranslateUi(self, Clustal):
        ...
        Clustal.setWindowTitle(_translate("Clustal", "Gene identification"))
        self.label.setText(_translate("Clustal", "Gene identification"))
        ...
        item.setText(_translate("Clustal", "Gene_ID"))
        self.label_5.setText(_translate("Clustal", "Ref fasta file"))
        self.label_7.setText(_translate("Clustal", "Blast mode"))
        self.pushButton_5.setText(_translate("Clustal", "Choose"))
        self.radioButton.setText(_translate("Clustal", "Nucleic mode"))
        self.radioButton_2.setText(_translate("Clustal", "Protein mode"))
        self.label_8.setText(_translate("Clustal", "Identification (%)"))
        self.label_9.setText(_translate("Clustal", "Gene coverage (%)"))
        self.label_10.setText(_translate("Clustal", "Same position coverage (%)"))
