...
class ProtVistaWeb_Form(QMainWindow):
    def __init__(self,content):
        ...
        url = "file://" + self.path + "/html/protvista/ProtVista.html"
        # 指定打开界面的 URL
        ...
        #####web页面加载完毕，调用函数
        # content = 'D:/tools/Pycharm/pyqt/html/GCview/data/GCF_000335355.json'
        self.browser.page().loadFinished.connect(lambda: self.run_js(content))  # 信号函数传参
