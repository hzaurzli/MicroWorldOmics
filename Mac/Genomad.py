...
class Genomad_Form(QWidget):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Genomad"))
        self.label_4.setText(_translate("Form", "Status"))
        self.label.setText(_translate("Form", "Genomad"))
        self.label_3.setText(_translate("Form", "Output folder"))
        self.label_2.setText(_translate("Form", "Input file (fa, file size less than 20M)"))
