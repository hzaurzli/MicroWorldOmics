...
# Form implementation generated from reading ui file 'ShinyMultifun.ui'
#
    ...
    def closeEvent(self, event):
        ...
        try:
            for conn in psutil.net_connections():
              if conn.laddr.port == 50756 and conn.status == 'LISTEN':
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                http.request('GET', 'http://127.0.0.1:50756')

                self.trigger.emit('ShinyApp has been started!!!')
            except:
                time.sleep(5)

class ShinyMultifun_Form(QWidget):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "ShinyMultifun"))
        self.label.setText(_translate("Form", "ShinyMultifun"))
    ...
    def open(self):
        ...
        if textbrowser == 'ShinyApp has been started!!!':
            self.winTable = ShinyWeb_Form(port=50756)
            self.winTable.show()
        else:
            w = QWidget()
