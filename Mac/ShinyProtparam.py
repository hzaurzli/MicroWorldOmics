...
# Form implementation generated from reading ui file 'ShinyProtparam.ui'
#
    ...
    def closeEvent(self, event):
        ...
        try:
            for conn in psutil.net_connections():
              if conn.laddr.port == 50326 and conn.status == 'LISTEN':
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                http.request('GET', 'http://127.0.0.1:50326')

                self.trigger.emit('ShinyApp has been started!!!')
            except:
                time.sleep(5)

class ShinyProtparam_Form(QWidget):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "ShinyProtparam"))
        self.label.setText(_translate("Form", "ShinyProtparam"))
