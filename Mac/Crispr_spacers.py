...
# Form implementation generated from reading ui file 'Crispr_spacers.ui'
#
...
class WorkThread(QThread):
    ...
    def run(self):
        def up_file(source_file, target_folder):
            ...
            # 执行命令
            stdin, stdout, stderr = ssh.exec_command('rm -r /home/xiaorunze/crispr_spacers/data/*')

            # 执行命令
            stdin, stdout, stderr = ssh.exec_command('rm -r /home/xiaorunze/crispr_spacers/out/*')
        ...
        def run_command(fasta):
            ...
            # 执行命令
            stdin, stdout, stderr = ssh.exec_command('python /home/xiaorunze/crispr_spacers/run_python.py -f %s' % (fasta))

            # 执行命令
            stdin, stdout, stderr = ssh.exec_command('bash /home/xiaorunze/crispr_spacers/run_crispr_spacers.sh')
        ...
        try:
            ...
            up_file(fasta, '/home/xiaorunze/crispr_spacers/data/' + os.path.basename(fasta))

            self.trigger.emit('Running the Crispr spacers!!!')
            ...
            port = 41526
            # 远程文件路径（需要绝对路径）
            remote_dir = '/home/xiaorunze/crispr_spacers/out/'
...
class Crispr_spacers_Form(QWidget):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Crispr spacer"))
        self.label_4.setText(_translate("Form", "Status"))
        self.label.setText(_translate("Form", "Crispr spacer"))
        self.pushButton_2.setText(_translate("Form", "Choose"))
        self.pushButton_3.setText(_translate("Form", "Choose"))
        self.label_2.setText(_translate("Form", "Input fasta file (fasta)"))
