...
class FastANI_Form(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.textBrowser_5.setStyleSheet("background-image: url(D:/tools/Pycharm/pyqt/logo/white.png)")
        ...
        self.textBrowser_6.setStyleSheet("background-image: url(D:/tools/Pycharm/pyqt/logo/white.png)")
        ...
        self.textBrowser_4.setStyleSheet("background-image: url(D:/tools/Pycharm/pyqt/logo/white.png)")
        ...
        self.radioButton.setStyleSheet("background-image: url(D:/tools/Pycharm/pyqt/logo/white.png)")
        ...
        self.radioButton_2.setStyleSheet("background-image: url(D:/tools/Pycharm/pyqt/logo/white.png)")
        ...
        self.radioButton_3.setStyleSheet("background-image: url(D:/tools/Pycharm/pyqt/logo/white.png)")
        ...
        self.radioButton_4.setStyleSheet("background-image: url(D:/tools/Pycharm/pyqt/logo/white.png)")
