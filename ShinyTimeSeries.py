...
# Form implementation generated from reading ui file 'ShinyTimeSeries.ui'
#
...
class winTest(QtWidgets.QWidget):
    ...
    def closeEvent(self, event):
        ...
        """
        try:
            with os.popen('netstat -aon|findstr "50735"') as res:
                res = res.read().split('\n')
            result = []
            for line in res:
            ...
            if len(result) != 0:
                for task in result:
                    if task['address'] == '127.0.0.1:50735':
                        pid = task['pid']
...
class ShinyTimeSeries_Form(QWidget):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "ShinyTimeSeries"))
        self.label.setText(_translate("Form", "ShinyTimeSeries"))
