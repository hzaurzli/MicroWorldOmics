...
class WorkThread(QThread):
    ...
    def run(self):
        ...
        def Gene_abstract_determine(ARG_location_use_dict, core_gene_list, out_folder, coverage,
                                    identical_percent):
            ARG_abstract_dict = {}
            ARG_location_dict = blast_filter(out_folder, coverage, identical_percent)
            for item in ARG_location_use_dict.items():
                Gene_filter_dict = {}
                Gene_list_filter = []
        ...
        try:
            ...
            ARG_location_dict = blast_filter(out_folder, coverage, ident)
...
class Core_genome_Form(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.textEdit_2, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.textBrowser_3, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.textBrowser_2, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.textBrowser, 12, 1, 2, 1)
        ...
        self.gridLayout.addWidget(self.textBrowser_4, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_6, 2, 0, 5, 1)
        ...
        self.gridLayout.addWidget(self.pushButton, 23, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Core genome analysis"))
        self.label_7.setText(_translate("Form", "Core genome concept"))
        ...
        self.label_5.setText(_translate("Form", "Ref fasta file (ffn)"))
        ...
        self.label.setText(_translate("Form", "Core genome analysis"))
