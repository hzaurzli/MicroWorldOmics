...
class GBK2JSON_Form(QWidget):
    ...
    def setupUi(self, Form):
        ...
        ## default
        self.textBrowser_2.setPlaceholderText("D:/input/test.gbk")
        self.textBrowser_3.setPlaceholderText("D:/output")

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "GBK2JSON"))
        self.label_4.setText(_translate("Form", "Status"))
        self.label.setText(_translate("Form", "GBK2JSON"))
        self.label_3.setText(_translate("Form", "Output folder"))
        self.label_2.setText(_translate("Form", "Input file (gbk)"))
