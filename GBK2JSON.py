...
# Form implementation generated from reading ui file 'GBK2JSON.ui'
#
...
class WorkThread(QThread):
    ...
    def run(self):
        def up_file(source_file, target_folder):
            ...
            # 执行命令
            stdin, stdout, stderr = ssh.exec_command('rm -r /home/xiaorunze/cgview/input/*')

            # 执行命令
            stdin, stdout, stderr = ssh.exec_command('rm -r /home/xiaorunze/cgview/output/*')
        ...
        def run_command(file):
            ...
            # 执行命令
            stdin, stdout, stderr = ssh.exec_command('python /home/xiaorunze/cgview/run_python.py -f %s' % (file))

            # 执行命令
            stdin, stdout, stderr = ssh.exec_command('bash /home/xiaorunze/cgview/run_cgview.sh')
        ...
        try:
            ...
            up_file(fasta,'/home/xiaorunze/cgview/input/' + os.path.basename(fasta))

            self.trigger.emit('Running the GBK2JSON!!!')
            ...
            port = 41526
            # 远程文件路径（需要绝对路径）
            remote_dir = '/home/xiaorunze/cgview/output'
...
class GBK2JSON_Form(QWidget):
    ...
    def retranslateUi(self, Clustal):
        ...
        Clustal.setWindowTitle(_translate("Clustal", "GBK2JSON"))
        self.label.setText(_translate("Clustal", "GBK2JSON"))
        self.label_2.setText(_translate("Clustal", "Input file (gbk)"))
